...
export const genresData: Genre[] = [
   ...
   { label: "Історичний", value: "HISTORICAL" },
   { label: "Наукова література", value: "SCIENTIFIC" },
   { label: "Художня література", value: "FICTION" },
   { label: "Дитяча література", value: "CHILDREN" },
];